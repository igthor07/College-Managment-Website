                 ...
                 <div class="media align-items-center">
                     ...
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                         <p>Name of Book : <?php echo"$name_of_book";?></p><hr>
                         <p>Book code : <?php echo"$code_of_book";?></p><hr>
                         <p>Issue Date :<?php echo"$issue_date";?></p><hr>
                         <p>Return Date : <?php echo"$return_date";?></p><hr>
                         <p>Payment pending : <?php echo"$payment_pending";?></p><hr>
